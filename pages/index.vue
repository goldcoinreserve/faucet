    ...
    <b-row>
      <b-col cols="12" lg="6">
        <div class="p-3">
          <b-col>
            <b-row>
              <b-img src="~/assets/images/gcr_logo.png" fluid alt="GCR" width=240 box-shadow: 0 0 8px 8px white inset></b-img>
            </b-row>
            <b-row>
              <div>
                <span class="subTitle">Claim tokens for development and testing purposes on the GCR network.</span>
              </div>
            </b-row>
...
<script>
  ...
  export default {
    ...
    computed: {
      ...
      amountPlaceholder() {
        return `(Faucet will pay up to ${this.networkInfo.nativeCurrencyMaxOut} of selected token, or enter custom amount)`
      },
      faucetAccountUrl() {
